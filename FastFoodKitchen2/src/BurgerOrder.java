...
public class BurgerOrder {
    ...
    public String toString() {
        return "Hamburgers: " + numHamburgers + ", Cheeseburgers: " + numCheeseburgers
                + ", Veggieburgers: " + numVeggieburgers + ", Sodas: " + numSodas + ", Is Order To Go: " + orderToGo;
    }
    
    public String updatedPrint()
    {
